...
| `src/model-capabilities.ts` | 7, 404                                   | **Added by Wave 1 Fase 1.1** — `deriveCapabilities` looks up the 2.1.195 catalogue singleton (frozen public signature takes only an id); multi-profile needs a profile-aware seam |
