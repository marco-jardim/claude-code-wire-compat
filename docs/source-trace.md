...
| Simple-prompt model eligibility | `lib/mimicry/system-prompt.mjs` |  99-117 | Simple-prompt eligibility is limited to recognized Opus 4.7/4.8 models and `-eap` variants; absent and other models are ineligible.                                                | `test/models.test.ts`                    |
